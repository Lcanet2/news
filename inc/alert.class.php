   ...
   **/
   ...
   public static function findAllToNotify($params = []) {
      ...
      if (!$p['show_only_login_alerts']) {
         $entity_sql = getEntitiesRestrictRequest("AND", $table, "", $p['entities_id'], Session::getIsActiveEntityRecursive());
      }
   ...
   static function displayOnCentral() {
      ...
      self::displayAlerts(['show_only_central_alerts' => true, Session::getActiveEntity()]);
      echo "</th></tr>";
   }
